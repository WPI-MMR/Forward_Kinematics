...
F21_T_F31 = DH_Transformation(theta11, 0, l11, d1)
F31_T_F41 = DH_Transformation(theta21, 0, l21, d2)
F41_T_F51 = DH_Transformation(theta31, 0, l3, 0)
...
F24_T_F34 = DH_Transformation(theta14, 0, l11, d1)
F34_T_F44 = DH_Transformation(theta24, 0, l21, d2)
F44_T_F54 = DH_Transformation(theta34, 0, l3, 0)
...
F22_T_F32 = DH_Transformation(theta12, 0, l12, d1)
F32_T_F42 = DH_Transformation(theta11, 0, l22, d2)
...
F23_T_F33 = DH_Transformation(theta12, 0, l12, d1)
F33_T_F43 = DH_Transformation(theta12, 0, l22, d2)
